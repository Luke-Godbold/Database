    ...
    <div className='App flex flex-col items-center justify-center gap-10'>
        ...
        <p className='p-2'>Total Attendance</p>
            <svg width="200" height="200">
                <circle r="70" cx="100" cy="100" fill="transparent" stroke="red" stroke-width="2rem" stroke-dasharray="439.8" stroke-dashoffset="0"></circle>
                <circle r="70" cx="100" cy="100" fill="transparent" stroke="#00C800" stroke-width="2rem" stroke-dasharray="439.8" stroke-dashoffset={439.8 - (overall / 100) * 439.8}></circle>
                <text x="100" y="105" textAnchor='middle' fill='#00C800'>{overall}%</text>
            </svg>
        </>
        )}
